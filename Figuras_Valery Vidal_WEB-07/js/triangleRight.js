class TriangleRight extends Figura {
    ...
    applyStyle() {
		...
		this.container.style.borderBottom = (this.width / 2) + 'px';
		this.container.style.borderBottomStyle = 'solid';
		this.container.style.borderBottomColor = 'transparent';

		this.container.style.borderTop = (this.width / 2) + 'px';
		this.container.style.borderTopStyle = 'solid';
		this.container.style.borderTopColor = 'transparent';
    }
}